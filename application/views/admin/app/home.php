                    ...
                    <div class="kt-widget4">
                        <div class="kt-widget4__item">
                            <div class="kt-widget4__pic kt-widget4__pic--icon">
                                <img src="<?= base_url(); ?>assets/media/files/doc.svg" alt="">
                            </div>
                        ...
                        <div class="kt-widget4__item">
                            <div class="kt-widget4__pic kt-widget4__pic--icon">
                                <img src="<?= base_url(); ?>assets/media/files/jpg.svg" alt="">
                            </div>
                            <a href="#" class="kt-widget4__title">
                        ...
                        <div class="kt-widget4__item">
                            <div class="kt-widget4__pic kt-widget4__pic--icon">
                                <img src="<?= base_url(); ?>assets/media/files/javascript.svg" alt="">
                            </div>
                            <a href="#" class="kt-widget4__title">
                                Make JS Development
                            </a>
                        ...
                        <div class="kt-widget4__item">
                            <div class="kt-widget4__pic kt-widget4__pic--icon">
                                <img src="<?= base_url(); ?>assets/media/files/zip.svg" alt="">
                            </div>
                            <a href="#" class="kt-widget4__title">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="kt-widget4">
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_4.jpg" alt="">
                                    </div>
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_14.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Milano Esco
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_11.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Nick Bold
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_1.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Wiltor Delton
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_5.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Nick Stone
                        ...
                        <div class="tab-pane" id="kt_widget4_tab2_content">
                            <div class="kt-widget4">
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_2.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Kristika Bold
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_13.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Ron Silk
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_9.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Nick Bold
                                ...
                                <div class="kt-widget4__item">
                                    <div class="kt-widget4__pic kt-widget4__pic--pic">
                                        <img src="<?= base_url(); ?>assets/media/users/100_8.jpg" alt="">
                                    </div>
                                    <div class="kt-widget4__info">
                                        <a href="#" class="kt-widget4__username">
                                            Nick Bold
        ...
        <div class="col-xl-4 col-lg-6 order-lg-1 order-xl-1">
            <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                    <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(<?= base_url(); ?>assets/media//products/product4.jpg)">
                    ...
                    <div class="kt-widget19__wrapper">
                        <div class="kt-widget19__content">
                            <div class="kt-widget19__userpic">
                                <img src="<?= base_url(); ?>assets/media//users/user1.jpg" alt="">
                            </div>
                        ...
                        <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                            ...
                            <div class="kt-timeline-v2__item">
                                ...
                                <div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
                                    <a href="#"><img src="<?= base_url(); ?>assets/media/users/100_4.jpg" title=""></a>
                                    <a href="#"><img src="<?= base_url(); ?>assets/media/users/100_13.jpg" title=""></a>
                                    <a href="#"><img src="<?= base_url(); ?>assets/media/users/100_11.jpg" title=""></a>
                                    <a href="#"><img src="<?= base_url(); ?>assets/media/users/100_14.jpg" title=""></a>
                                </div>
                            </div>
                            <div class="kt-timeline-v2__item">
...
<!-- <div class="container"> -->
    ...
    <div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <form class="form-horizontal" method="POST" action="<?= base_url(); ?>admin/Master/simpan_data_timeline" enctype='multipart/form-data'>
            <input type="hidden" name="from" value="beranda">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Tambah Jadwal Kegiatan</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                    <input type="text" name="kegiatan" class="form-control" id="title" placeholder="Nama Kegiatan">
                    </div>
                </div>
                <div class="form-group">
                    <label for="start" class="col-sm-12 control-label">Tanggal Mulai</label>
                    <div class="col-sm-12">
                    <input type="text" name="tanggal" class="form-control" id="start" readonly>
                    </div>
                </div>
                <div class="form-group">
                    <label for="end" class="col-sm-12 control-label">Tanggal Selesai</label>
                    <div class="col-sm-12">
                    <input type="text" name="tanggal_selesai" class="form-control" id="end" readonly>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="title" class="col-sm-12 control-label">Surat</label>
                    <div class="col-sm-12">
                ...
                <hr>
                <div class="form-group">
                    <label for="color" class="col-sm-12 control-label">Warna</label>
                    <div class="col-sm-12">
    ...
    <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
        <form class="form-horizontal" method="POST" action="<?= base_url(); ?>admin/Master/perbarui_data_timeline">
            <input type="hidden" name="from" value="beranda">
            <div class="modal-header">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group"> 
                        ...
                        <label class="kt-checkbox kt-checkbox--success">
                            <input type="checkbox" name="delete"> Hapus data
                            <span></span>
                        </label>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // 	$.ajax({
        // 	 url: '<?= base_url(); ?>admin/Master/simpan_data_timeline',
        // 	 type: "POST",
        // 	 data: {Event:Event},
