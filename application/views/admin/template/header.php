					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item <?php if($parent=='master_admin'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/administrator'; ?>" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-user-ok"></i><span class="kt-menu__link-text">Data Admin</span></a></li>
								<li class="kt-menu__item <?php if($parent=='master_member'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/data_petugas'; ?>" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-users-1"></i><span class="kt-menu__link-text">Data Petugas</span></a></li>
								<li class="kt-menu__item  kt-menu__item--submenu <?php if($parent=='master_kegiatan'){echo'kt-menu__item--open kt-menu__item--here';}else{echo'';} ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-notes"></i><span class="kt-menu__link-text">Kegiatan</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item <?php if($child=='jadwal_kegiatan'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/jadwal_kegiatan'; ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Jadwal Kegiatan</span></a></li>
											<li class="kt-menu__item <?php if($child=='timeline_kegiatan'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/timeline_kegiatan'; ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Timeline Kegiatan</span></a></li>
											<li class="kt-menu__item <?php if($child=='laporan_kegiatan'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/laporan_kegiatan'; ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Laporan Kegiatan</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__section ">
								...
								<li class="kt-menu__item <?php if($parent=='guest_book'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/buku_tamu'; ?>" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-computer"></i><span class="kt-menu__link-text">Daftar Pengunjung</span></a></li>
								<li class="kt-menu__item <?php if($parent=='log_activity'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/log_activity'; ?>" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-folder-1"></i><span class="kt-menu__link-text">Log Aktifitas</span></a></li>
								<li class="kt-menu__item <?php if($parent=='versioning_aplikasi'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="<?= base_url().'admin_side/versioning_aplikasi'; ?>" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-list-1"></i><span class="kt-menu__link-text">Versioning Aplikasi</span></a></li>
							</ul>
						</div>
					</div>
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									...
									<!-- <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(<?= base_url(); ?>assets/media/misc/bg-1.jpg)">
										<div class="kt-user-card__avatar">
											...
											use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it)
											<span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"><font style="text-transform: uppercase;"><?= substr($get_data_user->fullname,0,1); ?></font></span>
										</div>
										<div class="kt-user-card__name">
											<?= $get_data_user->fullname; ?>
										</div>
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<!-- <a href="#" class="btn btn-label-danger btn-bold">
										Export
									</a>
									<a href="#" class="btn btn-label-success btn-bold">
										Import
									</a>
