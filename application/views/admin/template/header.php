					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__item  kt-menu__item--submenu <?php if($parent=='master_kegiatan'){echo'kt-menu__item--open kt-menu__item--here';}else{echo'';} ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-icon flaticon-notes"></i><span class="kt-menu__link-text">Kegiatan</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item <?php if($child=='jadwal_kegiatan'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="#" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Jadwal Kegiatan</span></a></li>
											<li class="kt-menu__item <?php if($child=='timeline_kegiatan'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="#" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Timeline Kegiatan</span></a></li>
											<li class="kt-menu__item <?php if($child=='jlaporan_kegiatan'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="#" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Laporan Kegiatan</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__section ">
								...
								<li class="kt-menu__item <?php if($parent=='log_activity'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="index.html" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-folder-1"></i><span class="kt-menu__link-text">Log Aktifitas</span></a></li>
								<li class="kt-menu__item <?php if($parent=='versioning_aplikasi'){echo'kt-menu__item--active';}else{echo'';} ?>" aria-haspopup="true"><a href="index.html" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-list-1"></i><span class="kt-menu__link-text">Versioning Aplikasi</span></a></li>
							</ul>
						</div>
					</div>
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
									<div class="kt-header__topbar-user">
										...
										<img alt="Pic" class="kt-radius-100" src="<?= base_url(); ?>assets/media/users/300_25.jpg" />
