...
<link href='<?= base_url(); ?>assets/css/fullcalendar.css' rel='stylesheet' />
	<div class="modal fade" id="ModalAdd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<form class="form-horizontal" method="POST" action="<?= base_url(); ?>spv/Master/simpan_data_timeline" enctype='multipart/form-data'>
	...
	<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
		<form class="form-horizontal" method="POST" action="<?= base_url(); ?>spv/Master/perbarui_data_timeline">
			<input type="hidden" name="from" value="timeline_kegiatan">
			<div class="modal-header">
